...
<option value="Public Complaints">Public Complaints</option>
<option value="Personnel">Personnel</option>
<option value="Law Suits">Law Suits</option>
...
<label class="col-sm-2 col-sm-2 control-label">Local Goverment</label>
<div class="col-sm-4">
<select name="local goverment" required="required" class="form-control">
<option value="">Select Local Government Area</option>
<option value="Alimosho/Kosofe">Alimosho/Kosofe</option>
