...
<?php $st='closed';
$query=mysqli_query($bd, "select * FROM tblcomplaints");
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/Complaint-Management-System/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/Complaint-Management-System/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
